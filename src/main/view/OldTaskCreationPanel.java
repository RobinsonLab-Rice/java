...
//
//public class OldTaskCreationPanel extends JPanel {
//
...
//	 * Create the panel.
//	 */
//	public OldTaskCreationPanel(final TaskAdapter taskModelAdapter, final IView2SerializationAdapter IView2SerializationAdapter) {
...
//		visualizationTree = new TaskTree(new ExecutionModel(startingTask, taskModelAdapter));
